...
public class ConnectToServices : MonoBehaviourPunCallbacks
{
    ...
    {
        Debug.Log("Successfully joined the room. Global room count : " + PhotonNetwork.CountOfRooms);
        ...
        {
            GameObject instantiatedPlayer = Instantiate(_playerListing);
            instantiatedPlayer.transform.SetParent(_playerListContent);
            instantiatedPlayer.GetComponent<PlayerListItem>().SetUp(player);
        }

        if (PhotonNetwork.LocalPlayer.IsMasterClient) { _startButton.SetActive(true); }
    ...
    public override void OnRoomListUpdate(List<RoomInfo> roomList)
    {
        ...
        {
            Debug.Log("Room " + room);
            GameObject instantiatedRoom = Instantiate(_roomListing);
            ...
            instantiatedRoom.transform.SetParent(_roomListContent);
            instantiatedRoom.GetComponent<ListItem>().SetUp(room);
        }
        LayoutRebuilder.ForceRebuildLayoutImmediate(_roomListContent.gameObject.GetComponent<RectTransform>());
    ...
    public override void OnPlayerEnteredRoom(Player newPlayer)
    {
        ...
        GameObject instantiatedPlayer = Instantiate(_playerListing);
        instantiatedPlayer.transform.SetParent(_playerListContent);
        instantiatedPlayer.GetComponent<PlayerListItem>().SetUp(newPlayer);
    }
